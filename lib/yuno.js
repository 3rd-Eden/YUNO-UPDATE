(function(){
  ...
  e.innerHTML='<p style="top:0;position:absolute;font-family:Impact,Techno,sans-serif;color:#fff;font-size:41px;margin:-3px 0 0 0;padding:0;cursor:pointer">Internet Explorer '+ie+' user</p>'+
							'<p style="bottom:0;position:absolute;font-family:Impact,Techno,sans-serif;color:#fff;font-size: 29px;margin:0 0 -3px 0;padding:0;cursor:pointer">Y U NO UPDATE YOUR BROWSER TO IE9</p>';
	
  b.appendChild(e);
	
	// lightbox
  e = d.createElement('div');
	e.style.cssText="z-index:9998;position:absolute;background:#2b4663;margin:0;padding:0;height:100%;width:100%;float:none;top:0;left:0;cursor:pointer";
	b.appendChild(e);
